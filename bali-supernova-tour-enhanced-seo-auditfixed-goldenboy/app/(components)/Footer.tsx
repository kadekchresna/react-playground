    ...
    <footer className="bg-lava-900 text-gray-300 mt-24" id="footer">
      <div className="container grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 py-16">
        <div>
          <h3 className="text-white font-bold text-xl">
            Supernova Bali Airport Pickup & Day Tour
          </h3>
          <p className="mt-3 text-sm">
            Airport pickup service, private day tours, and island packages —
            guided by locals with a personal touch.
          </p>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li>
              WhatsApp:{" "}
              <a
                href="https://wa.me/6285738401557"
                target="_blank"
      ...
      <div className="border-t border-black/40">
        <div className="container py-6 text-center text-xs text-gray-400">
          © {year} Supernova Bali Airport Pickup & Day Tour. All rights
          reserved.
        </div>
      </div>
    </footer>
